 ...
 * Created by avalo.
 */
public class AddMultimediaRepositoryImpl implements AddMultimediaRepository {
    private EventBus eventBus;
    private FirebaseHelper helper;

    public AddMultimediaRepositoryImpl() {
    ...
    private void post(boolean error){
        AddMultimediaEvent event = new AddMultimediaEvent();
